...
if (isset($_GET['lu']) && $_GET['lu'] != '' && $verify_nonce)
{
...
<script type="text/javascript">
 ...
 {
    if (confirm('Are you sure that you want to delete this item? Note: This action cannot be undone.'))
    {        
...
<div class="wrap">
<h1>PayPal Form - Message List</h1>
