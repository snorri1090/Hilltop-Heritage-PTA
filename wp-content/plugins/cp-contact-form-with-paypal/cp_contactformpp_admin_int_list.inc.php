    ...
    <form name="updatesettings">
      Script load method:<br />
       <select id="ccscriptload" name="ccscriptload">
        <option value="0" <?php if (get_option('CP_CFPP_LOAD_SCRIPTS',(CP_CONTACTFORMPP_DEFAULT_DEFER_SCRIPTS_LOADING?"1":"0")) == "1") echo 'selected'; ?>>Classic (Recommended)</option>
        <option value="1" <?php if (get_option('CP_CFPP_LOAD_SCRIPTS',(CP_CONTACTFORMPP_DEFAULT_DEFER_SCRIPTS_LOADING?"1":"0")) != "1") echo 'selected'; ?>>Direct</option>
       </select><br />
...
[<a href="https://wordpress.org/support/plugin/cp-contact-form-with-paypal#new-post" target="_blank">Request Custom Modifications</a>] | [<a href="https://wordpress.org/support/plugin/cp-contact-form-with-paypal#new-post" target="_blank">Help</a>]
</form>
</div>
